...
* Version 1.0
Version 1.0 must have the basic functionality fully functional.
** Parameters
*** TODO Source Factory
Created a BaseSourceFactory class to simplify implementation of different kinds of SourceFactory.
