...
#+INCLUDE: src\test\groovy\edu\sunyjcc\simple_report\SimpleReportBuilderTest.groovy src groovy -n  :lines "58-60"
(From [[file:src\test\groovy\edu\sunyjcc\simple_report\SimpleReportBuilderTest.groovy][SimpleReportBuilderTest.groovy]])
** Creating a Parameter List
#+INCLUDE: src\test\groovy\edu\sunyjcc\simple_report\SimpleReportBuilderTest.groovy src groovy -n  :lines "73-77"
(From [[file:src\test\groovy\edu\sunyjcc\simple_report\SimpleReportBuilderTest.groovy][SimpleReportBuilderTest.groovy]])
** Creating a Report with a CSV Data Source
#+INCLUDE: src\test\groovy\edu\sunyjcc\simple_report\SimpleReportBuilderCsvTest.groovy src groovy -n :lines  "40-43"
